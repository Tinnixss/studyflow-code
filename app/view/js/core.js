// ============================================================
// StudyFlow | core.js — Utilitários Compartilhados (UNIVERSAL)
// ============================================================
...
function initTheme() {
  ...
  function aplicarVisualTema(tema) {
    ...
    if (elementoTema.type === 'checkbox') elementoTema.checked = (tema === 'light');
...
// ── Navbar e Menu Mobile Sem Conflitos ───────────────────────
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Sincroniza dinamicamente o Nome e Avatar do Perfil na Navbar de todas as abas!
  try {
    ...
    console.warn('[StudyFlow] Erro ao sincronizar dados da navbar:', e);
  }
});

// Sistema de Toast Unificado (Substitui o mostrarToast antigo)
